...
public class AleatorioEmple {
	...
	public static void main(String[] args) throws IOException {
		System.out.println("Añado una línea de visualización para el método principal");
		crear();
		leer();
	}

	public static void leer() throws IOException {
		System.out.println("Añado una línea de visualización para el método leer");
	...
	public static void crear() throws IOException {
		System.out.println("Añado una línea de visualización para el método crear");
		File fichero = new File("AleatorioEmple.dat");
